            ...
            <>
              ...
              <div className="flex flex-col gap-4 p-4 pt-0">
                <div className="rounded-xl w-full mt-5 bg-fblue-700 flex flex-col md:flex-row md:gap-6 py-6 items-center lg:px-8 lg:gap-12">
                  ...
                  <div>
                    <h3 className="text-3xl font-semibold text-fgray-200 lg:text-4xl">You can do it!!</h3>
                    <p className="text-xl font-semibold text-fgray-400 mt-2">We believe in you...</p>
                  </div>
                </div>
              </div>
              <Courses />
