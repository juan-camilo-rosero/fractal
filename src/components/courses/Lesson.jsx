...
function Lesson({preview, lesson}) {
  return (
    <figure className={`flex flex-row gap-4 p-2 rounded-lg w-full ${lesson.completed ? "bg-fblue-700" : "bg-fgray-200"} cursor-pointer`} onClick={e => location.href=lesson.url}>
